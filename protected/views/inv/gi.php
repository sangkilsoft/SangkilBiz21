...
$('#saveBtn').click(function(){
        ...
        if (!confirm('Are you sure?')) return false;
            ...
            var data = $('#invgi-form').serializeArray();
...
function sukses(r,sender){
    ...
    if(ret.type == 'S'){    
        $('#InvgiHdr_gi_num').val(ret.val);
        $('#InvgiHdr_gi_num').attr('readonly','true');
        $('#cancelBtn').click();
    }else if(ret.type == 'W'){
        alert(ret.message);
    }else if(ret.type == 'E'){
        var msg = ret.message;     
        if(typeof msg.cdunit != 'undefined'){ alert(msg.cdunit); return;}
        if(typeof msg.cdwhse != 'undefined'){ alert(msg.cdwhse); return;}
        if(typeof msg.refnum != 'undefined'){ alert(msg.refnum); return;}
        if(typeof msg.date_gr != 'undefined'){ alert(msg.date_gr); return;}
    }
    return true;
}        
...
<div id="content-form">
    <div class="form">
        ...
        <table border="0" width="100%">
            <tr>
                <td><?php echo $form->labelEx($model, 'gi_num'); ?></td>
                <td>
                    <?php
                    echo $form->textField($model, 'gi_num', array('size' => 12));
            ...
            <tr>
                ...
                <td> 
                    ...
                    echo CHtml::activeDropDownList($model, 'cdunit', $listunit, array('width' => '700px',
                        ...
                        'ajax' => array(
                            'type' => 'POST',
                            'url' => CController::createUrl('actGIWhse'),
                            'update' => '#InvgiHdr_cdwhse',
                        ),
                    ));
                    ?>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    echo $form->textArea($model, 'dscrp', array('cols' => 24, 'rows' => '2',
                        'maxlength' => 64));
                    ?></td>
                <td><?php echo $form->labelEx($model, 'date_gr'); ?></td>
                <td>
                    <?php
        ...
        $this->beginWidget('mdmEui.MdmDialog', array(
            'htmlOptions' => array('id' => 'dlg','width'=>'1705'),
            'options' => array(
                'title' => 'Test Dialogue',
                'autoOpen'=>false,
                'modal'=>true,
