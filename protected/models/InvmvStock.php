 ...
 */
class InvmvStock extends CActiveRecord {

    /**
     * Returns the static model of the specified AR class.
     * @return InvmvStock the static model class
     */
    ...
    public function rules() {
        ...
        return array(
            array('id_periode, cditem, cduom, cdwhse, refnum, date_mv', 'required'),
            array('id_periode, lnitem, update_by, create_by', 'numerical', 'integerOnly' => true),
            array('qtymv, qtynow', 'numerical'),
            array('cditem, cduom, cdwhse', 'length', 'max' => 13),
            array('create_date, update_date', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('mvstock_id, id_periode, cditem, lnitem, cduom, cdwhse, refnum, date_mv, qtymv, qtynow, update_by, create_date, update_date, create_by', 'safe', 'on' => 'search'),
        );
    }
