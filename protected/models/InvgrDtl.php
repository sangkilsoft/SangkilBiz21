...
/**
 * This is the model class for table "minidb.invgr_dtl".
 *
 * The followings are the available columns in table 'minidb.invgr_dtl':
 ...
 */
class InvgrDtl extends CActiveRecord {

    /**
     * Returns the static model of the specified AR class.
     * @return InvgrDtl the static model class
     */
    ...
    public function rules() {
        ...
        return array(
            array('gr_num, lnum, cditem, cduom,markup', 'required'),
            array('lnum, lnitem, update_by, create_by', 'numerical', 'integerOnly' => true),
            array('qty, uomcost, uomprice', 'numerical'),
            array('gr_num, cditem, cduom', 'length', 'max' => 13),
            array('update_date, create_date', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('gr_num, lnum, cditem, lnitem, cduom, qty, uomcost, uomprice, update_date, create_date, update_by, create_by', 'safe', 'on' => 'search'),
        );
    }
