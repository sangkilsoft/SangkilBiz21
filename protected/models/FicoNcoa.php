...
class FicoNcoa extends CActiveRecord {
    ...
    public function relations() {
        ...
        return array(
            'getparent' => array(self::BELONGS_TO, 'FicoNcoa', 'parent_id_coa'),
            'childs' => array(self::HAS_MANY, 'FicoNcoa', 'parent_id_coa', 'order' => 'childs.id_coa ASC'),
            'childsCount' => array(self::STAT, 'FicoNcoa', 'parent_id_coa'),
        );
    }
