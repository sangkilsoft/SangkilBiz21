...
/**
 * This is the model class for table "minidb.invpurch_hdr".
 *
 * The followings are the available columns in table 'minidb.invpurch_hdr':
 ...
 */
class InvpurchHdr extends CActiveRecord {

    /**
     * Returns the static model of the specified AR class.
     * @return InvpurchHdr the static model class
     */
    ...
    public function rules() {
        ...
        return array(
            array('purch_num, cdvend, id_periode, dscrp, refnum, status, cdunit, gr_num, bill_num, cdwhse, termofpayment', 'required'),
            array('id_periode, create_by, update_by', 'numerical', 'integerOnly' => true),
            array('purch_num, cdvend, cdunit, gr_num, cdwhse', 'length', 'max' => 13),
            array('dscrp', 'length', 'max' => 128),
            array('refnum', 'length', 'max' => 32),
            array('create_date, update_date', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('purch_num, cdvend, id_periode, dscrp, refnum, status, cdunit, gr_num, bill_num, cdwhse, termofpayment, create_by, create_date, update_by, update_date', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('termofpayment', $this->termofpayment, true);
